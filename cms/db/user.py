...
# Set when an administrator impersonates a contestant (upstream's admin
# impersonation feature, expressed here as a session-token source).
SESSION_TOKEN_SOURCE_ADMIN_IMPERSONATION = 'admin_impersonation'
